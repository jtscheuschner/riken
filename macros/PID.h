...
// Fri Jul 31 09:46:45 2015 by ROOT version 5.34/25
...
class PID {
 public :
  ...
  //  ~PID();
  //functions
  void Fitting(TH2F* h2, short aoq, short var);
  void Outgoing(TH2F* h2_angle_a, TH2F* h2_angle_b,
		TH2F* h2_pos_x, TH2F* h2_pos_y, TH2F* h2_pos_x_, TH2F* h2_pos_y_,
		TH2F* h2_beta);
  void Histo(short var);
  void Write(Char_t* name);
  void Reset();
  void AoQ();
  void ReadIncoming();
  void ReadOutgoing_1();
  ...
  TH2F* fh2_aoq_0_angle_F3;
  TH2F* fh2_aoq_0_angle_F5;
  TH2F* fh2_aoq_0_xpos_F3;
  TH2F* fh2_aoq_0_xpos_F5;
  TH2F* fh2_aoq_0_ypos_F3;
  TH2F* fh2_aoq_0_ypos_F5;
  TH2F* fh2_aoq_0_beta;

  TH2F* fh2_aoq_1_angle_F8;
  TH2F* fh2_aoq_1_angle_F10;
  TH2F* fh2_aoq_1_xpos_F8;
  TH2F* fh2_aoq_1_xpos_F10;
  TH2F* fh2_aoq_1_ypos_F8;
  TH2F* fh2_aoq_1_ypos_F10;
  TH2F* fh2_aoq_1_beta;

  TH2F* fh2_aoq_2_angle_F10;
  TH2F* fh2_aoq_2_angle_F11;
  TH2F* fh2_aoq_2_xpos_F10;
  TH2F* fh2_aoq_2_xpos_F11;
  TH2F* fh2_aoq_2_ypos_F10;
  TH2F* fh2_aoq_2_ypos_F11;
  TH2F* fh2_aoq_2_beta;
  
  TH2F* fh2_aoq_3_angle_F8;
  TH2F* fh2_aoq_3_angle_F10;
  TH2F* fh2_aoq_3_angle_F11;
  TH2F* fh2_aoq_3_xpos_F8;
  TH2F* fh2_aoq_3_xpos_F10;
  TH2F* fh2_aoq_3_xpos_F11;
  TH2F* fh2_aoq_3_ypos_F8;
  TH2F* fh2_aoq_3_ypos_F10;
  TH2F* fh2_aoq_3_ypos_F11;
  TH2F* fh2_aoq_3_beta;
  ...
  TH1F* fh1_CorrAoQ[4];
   ...
   virtual void     Loop(short iteration, short var);
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("data/rootfiles/test/run0001_299.800_-159.735.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("data/rootfiles/test/run0001_299.800_-159.735.root");
      }
...
void PID::Init(TTree *tree)
{
  ...
  for(short aoq = 0; aoq < 4; aoq++){
    for(short jj = 0; jj < 7; jj++)
      fcorr_Lin[aoq][jj] = 0;
  }
